...
public class activity_8_learn_instrument extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_8_learn_instrument);

        // *************** Variables ***************

        //Background animation
        TextView textView= findViewById(R.id.top_8);
    ...
    public void animatePage() {
        ...
        guitar_btn.animate().scaleX(1.07f).scaleY(1.07f).setDuration(700).withEndAction(new Runnable() {
            @Override
            public void run() {
                guitar_btn.animate().scaleX(1.0f).scaleY(1.0f).setDuration(700);
            }
        });
