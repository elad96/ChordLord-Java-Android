...
public class activity_9_learn_chords_guitar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_9_learn_chords_guitar);

        // *************** Variables ***************

        //Background animation
        TextView textView= findViewById(R.id.top_9);
        ...
        // -------- Grid --------
        final GridLayout gridLayout = findViewById(R.id.guitar_grid);
        ...
        for (int i=0 ; i<25; i++){
            ...
            // Create Button
            Button chord_btn = new Button(activity_9_learn_chords_guitar.this);
            ...
            chord_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    activity_11_intent.putExtra("instrument","guitar");
